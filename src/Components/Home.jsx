    ...
    return(
        <div className="fullscreen">
            <div className="home" id="hero" >
                ...
                <div>
                <button onClick={() => window.open("https://www.drdo.gov.in/drdo/labs-establishment/contact-us/solid-state-physics-laboratory-sspl")} className="btn" style={{ marginRight: '40px', textDecoration: 'none' }}>Explore SSPL</button>
                <button onClick={() => window.open("https://www.bits-pilani.ac.in/")} className="btn" >Explore BITS</button>
                </div>
            </div>
        </div>
